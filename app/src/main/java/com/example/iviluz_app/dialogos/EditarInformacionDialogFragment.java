...
public class EditarInformacionDialogFragment extends DialogFragment {
    ...
    public EditarInformacionDialogFragment() {
    ...
    private AlertDialog crearDialogo() {
        ...
        View v = inflater.inflate(R.layout.fragment_editar_informacion_dialog, null);
        builder.setView(v);
            ...
            public void onClick(View view) {
                if (networkInfo != null && networkInfo.isConnected()) {
                    if (titulo.getText().toString().equals("")
                        ...
                        firestore.collection("Informacion").document(ID).update(infoMap)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_editar_informacion_dialog, container, false);
    }
